...
class VendasStf extends StatefulWidget {
  const VendasStf({super.key});
  @override
  State<VendasStf> createState() => _VendasStfState();
}

class _VendasStfState extends State<VendasStf> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(children: [
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Image.network(
                    'https://cdn-icons-png.flaticon.com/512/3091/3091221.png',
                    height: 100,
                    width: 100,
                  ),
                  Padding(
