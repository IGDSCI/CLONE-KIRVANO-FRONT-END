      ...
      body: Row(children: [
        Container(
          ...
          child: Column(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 40, bottom: 30, top: 20),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 40, bottom: 30, top: 10),
              child: Row(mainAxisAlignment:MainAxisAlignment.start, children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 40, bottom: 30, top: 290),
              child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                Icon(Icons.wb_sunny),
                Text(' Claro/Escuro',
                style: TextStyle(
