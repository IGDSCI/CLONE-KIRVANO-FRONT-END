...
class FinancasStf extends StatefulWidget {
  const FinancasStf({super.key});
  @override
  State<FinancasStf> createState() => _FinancasStfState();
}

class _FinancasStfState extends State<FinancasStf> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(children: [
            ...
            children: [
                                ...
                                Align(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                          'Quando surgirem, você poderá visualizá-los por aqui.',
                                          ),
                                    ],
                                  ),
                                ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Image.network(
                      'https://cdn-icons-png.flaticon.com/512/6802/6802306.png',
                      width: 140,
                    ),
                    Text(
                      'Não há registros...',
                    ...
                    Text(
                      'Quando surgirem, você poderá gerenciá-los por aqui.',
                      )
                  ],
                ),
              )
