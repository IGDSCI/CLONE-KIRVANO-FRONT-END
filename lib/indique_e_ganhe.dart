...
class _IndiqueEGanheStfState extends State<IndiqueEGanheStf> {
  final TextEditingController _textController = TextEditingController(text: 'https://app.kirvano.com/signup?ref=J69W4BJ6');
              ...
              Row(
                children: [
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          width: 750,
                          child: Text(
                            'Convide amigos e fique com 10% sobre as taxas* que a Kirvano receber das vendas do seu contato indicado. Incrível, né?',
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 15),
                        child: Text(
                          'Convide seus contatos através do seu link pessoal:',
                  ...
                  Padding(
                    ...
                    child: Image.network(
                      'https://cdn-icons-png.flaticon.com/512/6593/6593057.png',
                      height: 180,
                    ),
                  )
                ],
