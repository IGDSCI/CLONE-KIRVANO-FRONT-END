                                ...
                                AccordionSection(
                                  ...
                                  header: const Text(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold)),
                                  content: const Text(
                                      'A Kirvano é uma plataforma gratuita para montar seu negócio digital. Você não paga nada para começar, apenas uma porcentagem sobre as vendas.',
                                      style: TextStyle(fontSize: 18)),
                                ),
                              ]),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Accordion(paddingListTop: 0, children: [
                            AccordionSection(
                              ...
                              rightIcon: Icon(Icons.keyboard_arrow_up_sharp),
                              header: const Text(
                                  '02 Vendo um produto físico, posso usar a Kirvano?',
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold)),
                              content: const Text(
                                  'A plataforma é exclusiva para produtos e serviços digitais.',
                                  style: TextStyle(fontSize: 18)),
                            ),
                          ]),
                        ),
                              ...
                              header: const Text(
                                '03 Para quem é a Kirvano?',
                                  style: TextStyle(
                                      ...
                                      fontWeight: FontWeight.bold)),
                              content: const Text(
                                  'A Kirvano é uma plataforma completa para quem é produtor digital, afiliado ou para quem vende serviços on-line (telemedicina, closefriends, SaaS e etc).',
                                  style: TextStyle(fontSize: 18)),
                            ),
                          ]),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Accordion(paddingListTop: 0, children: [
                            AccordionSection(
                              ...
                              rightIcon: Icon(Icons.keyboard_arrow_up_sharp),
                              header: const Text(
                                  '04 Quantos produtos posso vender pela Kirvano?',
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold)),
                              content: const Text(
                                  'Não há limite para o número de produtos digitais que você pode criar e vender na Kirvano.',
                                  style: TextStyle(fontSize: 18)),
                            ),
                          ]),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Accordion(paddingListTop: 0, children: [
                            AccordionSection(
                              ...
                              rightIcon: Icon(Icons.keyboard_arrow_up_sharp),
                              header: const Text(
                                  '05 Qual a taxa para vendas realizadas?',
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold)),
                              content: const Text(
                                  'A Kirvano oferece a menor taxa do mercado para infoprodutores: 4,9% + R\$2,00 por venda aprovada.',
                                  style: TextStyle(fontSize: 18)),
                            ),
                          ]),
                        ),
