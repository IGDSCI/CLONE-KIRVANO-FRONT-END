...
class ConfiguracoesStl extends StatelessWidget {
  const ConfiguracoesStl({super.key});
  @override
...
class ConfiguracoesStf extends StatefulWidget {
  const ConfiguracoesStf({super.key});
  @override
  State<ConfiguracoesStf> createState() => _ConfiguracoesStfState();
}

class _ConfiguracoesStfState extends State<ConfiguracoesStf> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(children: [
