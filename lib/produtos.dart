...
class ProdutosStl extends StatelessWidget {
  const ProdutosStl({super.key});
  @override
...
class ProdutosStf extends StatefulWidget {
  const ProdutosStf({super.key});
  @override
  State<ProdutosStf> createState() => _ProdutosStfState();
}

class _ProdutosStfState extends State<ProdutosStf> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(children: [
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child:
                          Text('Aqui serão listados todos os seus produtos.'),
                    ),
                  ],
                ),
              )
