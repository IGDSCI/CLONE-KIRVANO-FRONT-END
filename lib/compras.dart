...
class ComprasStf extends StatefulWidget {
  const ComprasStf({super.key});
  @override
  State<ComprasStf> createState() => _ComprasStfState();
}

class _ComprasStfState extends State<ComprasStf> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Aqui serão listadas suas compras.')
                  ],
                ),
              )
            ],
